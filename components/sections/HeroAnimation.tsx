...
import { Globe, Server, Smartphone, Cloud, Shield, Lock, FileSearch, Target, Layers, Crosshair } from "lucide-react";

const services = [
    { icon: Globe, label: "Web Security", x: -220, y: -100 },
    { icon: Server, label: "API Testing", x: 220, y: -100 },
    { icon: Smartphone, label: "Mobile App", x: -220, y: 100 },
            ...
            >
                <div className="relative">
                    ...
                    <div className="relative w-40 h-48 flex items-center justify-center">
                        <Shield className="text-blue-600 w-24 h-24" strokeWidth={1.5} />
                    </div>
                </div>
            </motion.div>
